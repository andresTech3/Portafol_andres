...
function About() {
  return (
    <div className='p-5'>
        <h2 className='text-center mt-10 text-2xl' >Hacerca de mi</h2>
        <hr className='w-20 m-auto border-teal-500 '/>
        <hr className='w-10 m-auto mt-2 border-teal-500 '/>
        <p className='mt-5 px-20'><span className='text-teal-500'>Hola mi nombre es Andres Narvaez </span>quiere que te ayude a mejorar tu presencia online y optimizar procesos para mejorar tu rendimiento y atraer mas clientes ? descubre como 👇</p>
